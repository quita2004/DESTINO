...
<body class="common-home res layout-home5">
	...
	<div id="wrapper" class="wrapper-full banners-effect-8">
			...
			<div class="header-top">
				<div class="container-fluid">
					<div class="row">
							...
							<div class="form-group languages-block ">
								<form action="index.html" method="post" enctype="multipart/form-data" id="bt-language">
									...
									<ul class="dropdown-menu" >
										...
										<li> <a href="html_width_RTL/home5.php"> <img class="image_flag" src="img/demo/flags/lb.png" alt="Arabic" title="Arabic"> Arabic </a> </li>
									</ul>
								</form>
							</div>
						...
						<div class="header-top-right collapsed-block   col-sm-5 col-xs-6 compact-hidden text-right">

							<div>
								<ul class="top-link list-inline">
									<li class="wishlist hidden-xs hidden-sm"><a href="#" id="wishlist-total" class="top-link-wishlist" title="Welcome Customer!"><span>Welcome Customer!</span></a></li>
		...
		<div class="content-main">
			<section class="so-spotlight1 container-fluid">
				<div class="owl-slider">
					<div class="owl-carousel " data-margin="0" data-nav="yes" data-loop="yes" data-items_xs="1" data-items_sm="1" data-items_md="1">
						<div class="slider">
							<a href="#"><img src="img/demo/slider/home-5/slider-1.jpg" alt=""></a>
						</div>
						<div class="slider">
							<a href="#"><img src="img/demo/slider/home-5/slider-2.jpg" alt=""></a>
						</div>
						<div class="slider">
							<a href="#"><img src="img/demo/slider/home-5/slider-3.jpg" alt=""></a>
						</div>
					</div>
				</div>
			</section>
				...
				<div class="collections container-fluid">
					<div class="collection collection-1">
						<div class="img-collection">
							<img src="img/demo/collections/home-5/collection-1.jpg" alt="">
						</div>
						<div class="info-collection">
							<h3><a href="#">For men</a></h3>
							<ul>
					...
					<div class="collection collection-2">
						<div class="img-collection">
							<img src="img/demo/collections/home-5/collection-2.jpg" alt="">
						</div>
						<div class="info-collection">
							<h3><a href="#">For women</a></h3>
							<ul>
								<li><a href="#">Clothing</a></li>
								<li><a href="#">Dresses</a></li>
								<li><a href="#">Jumpsuit</a></li>
					...
					<div class="collection collection-3">
						<div class="img-collection">
							<img src="img/demo/collections/home-5/collection-3.jpg" alt="">
						</div>
						<div class="info-collection">
			...
			<section class="so-spotlight3">
				<div class="container-fluid">
					<div class="row">
						<div class="col-sm-12">
							<h3 class="modtitle4">Latest Products</h3>
							<hr>
							<div class="text">
								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor</p>
								<p>incididunt ut labore et dolore magna aliqua</p>
							</div>
							<div class=" owl-carousel owl-new-arrivals " data-dots="no" data-nav="yes" data-loop="yes" data-items_xs="1" data-items_sm="4" data-items_md="5" data-margin="30">
			...
			<section class="so-spotlight4">
				<div class="container">
					<div class="row">
						<div class="col-sm-12">
							<h3 class="modtitle4">Our Collections</h3>
							<hr>
							<div class="text">
								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor</p>
								<p>incididunt ut labore et dolore magna aliqua</p>
							...
							<div class="categories">
								<div class="item-category category-1">
									<a href="#">
										<img src="img/theme/icon/home-5/category/icon-1.png" alt="">
										<p>Clothing</p>
									</a>
								</div>
								<div class="item-category category-2">
									<a href="#">
										<img src="img/theme/icon/home-5/category/icon-2.png" alt="">
										<p>Shoes</p>
									</a>
								</div>
								<div class="item-category category-3">
									<a href="#">
										<img src="img/theme/icon/home-5/category/icon-3.png" alt="">
										<p>HandBags</p>
									</a>
								</div>
								<div class="item-category category-4">
									<a href="#">
										<img src="img/theme/icon/home-5/category/icon-4.png" alt="">
										<p>SUNGLASSES</p>
									</a>
								</div>
								<div class="item-category category-5">
									<a href="#">
										<img src="img/theme/icon/home-5/category/icon-5.png" alt="">
										<p>ACCESSORIES</p>
									</a>
								</div>
							</div>
					...
					<div class="row">
						<div class="col-sm-12 col-xs-12">
							<div class="owl-testimonials">
								<div class="owl-carousel" data-nav="no" data-loop="yes" data-margin="0" data-dots="yes" data-items_xs="1" data-items_sm="1" data-items_md="1">
									<div class="item">
										<p class="client-comment">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut laboreet dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
										<div class="info-client">
											<span>Johny Walker</span>
							...
							<div class="instagram">
								<div class="img-instagram">
									<div class="">
										<div class="img-row-1">
											<div class="item-img">
												<a href="#"><img src="img/demo/instagram/i1.jpg" alt="Instagram"></a>
											</div>
											<div class="item-img">
												<a href="#"><img src="img/demo/instagram/i2.jpg" alt="Instagram"></a>
											</div>
											<div class="item-img">
												<a href="#"><img src="img/demo/instagram/i3.jpg" alt="Instagram"></a>
											</div>
											<div class="item-img">
												<a href="#"><img src="img/demo/instagram/i4.jpg" alt="Instagram"></a>
											</div>
											<div class="item-img">
												<a href="#"><img src="img/demo/instagram/i5.jpg" alt="Instagram"></a>
											</div>
											<div class="item-img">
												<a href="#"><img src="img/demo/instagram/i6.jpg" alt="Instagram"></a>
											</div>
										</div>
										<div class="img-row-2">
											<div class="item-img">
												<a href="#"><img src="img/demo/instagram/i7.jpg" alt="Instagram"></a>
											</div>
											<div class="item-img">
												<a href="#"><img src="img/demo/instagram/i8.jpg" alt="Instagram"></a>
											</div>
											<div class="item-img">
												<a href="#"><img src="img/demo/instagram/i9.jpg" alt="Instagram"></a>
											</div>
											<div class="item-img">
												<a href="#"><img src="img/demo/instagram/i10.jpg" alt="Instagram"></a>
											</div>
											<div class="item-img">
												<a href="#"><img src="img/demo/instagram/i11.jpg" alt="Instagram"></a>
											</div>
											<div class="item-img">
												<a href="#"><img src="img/demo/instagram/i12.jpg" alt="Instagram"></a>
											</div>
										</div>
									</div>
								</div>
								<div class="info-instagram">
									<div class="info-instagram-border">
										<h3>#Destino</h3>
										<p>Fashion Style of Life (on Instagram)</p>
			...
			<section class="so-spotlight7">
				<div class="container">
					<div class="row">
						<div class="col-sm-12 col-xs-12">
							<h3 class="modtitle4">Newsletter</h3>
							<hr>
							<div class="text">
								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor</p>
								<p>incididunt ut labore et dolore magna aliqua</p>
							...
							<div class="email ">
								<input type="email" placeholder="Enter email address..." value="" class="form-control" id="txtemail" name="txtemail" size="55">
								<div class="subcribe">
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				...
				<div class="modal-body"> 
					<textarea id="getCSSTextarea" class="get-css" readonly=""><?php $fileCssName = !empty($themeCssName) ?  $themeCssName : 'home5.css'; echo '/********************************************
						' ;
