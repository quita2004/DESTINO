...
<body class="common-home res layout-home4">
	...
	<div id="wrapper" class="wrapper-full banners-effect-8">
		...
		<div class="content-top">
			...
			<!-- Header Container  -->
			<header id="header" class=" variantleft type_4 box-full">
				<!-- Header Top -->
							...
							<div class="header-top-right collapsed-block text-right  col-sm-6 col-xs-6 compact-hidden">
								...
								<div class="tabBlock" id="TabBlock-1">
									<ul class="top-link list-inline">
										...
										<li class="checkout"><a href="login.html" class="top-link-checkout" title="Login"><span>Login</span></a></li>
										<li class="login"><a href="register.html" title="Register"><span>Register</span></a></li>
									</ul>
								</div>
							</div>
								...
								<div class="form-group languages-block ">
									<form action="index.html" method="post" enctype="multipart/form-data" id="bt-language">
										...
										<ul class="dropdown-menu" >
											...
											<li> <a href="html_width_RTL/home4.php"> <img class="image_flag" src="img/demo/flags/lb.png" alt="Arabic" title="Arabic"> Arabic </a> </li>
										</ul>
									</form>
								</div>
				...
				<div class="header-center left">
					<div class="container-fluid">
						<div class="row">
							<!-- Logo -->
							<div class="navbar-logo col-md-3 col-sm-8 col-xs-12">
								<a href="index.php"><img src="img/demo/logo/home-4/logo.png" title="Your Store" alt="Your Store"></a>
							</div>
							<!-- //end Logo -->

							<div class="megamenu-hori   col-md-7 col-sm-2 col-xs-6 ">
							...
							<!-- Secondary menu -->
							<div class="col-md-2 col-sm-2 col-xs-6 shopping_cart pull-left">
			...
			<!-- //Header Container  -->
			<!-- Block Spotlight1  -->
			<section class="so-spotlight1 box-full">
				<div class="container-fluid">
					<div class="row">
						<div class="slider-1">
							<div class="col-sm-12 owl-slider-1">
								<div class="owl-carousel" data-margin="0" data-loop="yes" data-nav="yes" data-dots="no" data-items_xs="1" data-items_sm="1" data-items_md="1">
									<div class="img-slider-1">
										<a href="#"><img src="img/demo/slider/home-4/slider-1.jpg" alt=""></a>
									</div>
									<div class="img-slider-1">
										<a href="#"><img src="img/demo/slider/home-4/slider-2.jpg" alt=""></a>
									</div>
									<div class="img-slider-1">
										<a href="#"><img src="img/demo/slider/home-4/slider-3.jpg" alt=""></a>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="categories">
									...
									<div class="item-category category-1">
										<a href="#">
											<img src="img/theme/icon/home-4/icon-1.png" alt="">
											<p>Clothing</p>
										</a>
									</div>
									<div class="item-category category-2">
										<a href="#">
											<img src="img/theme/icon/home-4/icon-2.png" alt="">
											<p>Shoes</p>
										</a>
									</div>
									<div class="item-category category-3">
										<a href="#">
											<img src="img/theme/icon/home-4/icon-3.png" alt="">
											<p>HandBags</p>
										</a>
									</div>
									<div class="item-category category-4">
										<a href="#">
											<img src="img/theme/icon/home-4/icon-4.png" alt="">
											<p>SUNGLASSES</p>
										</a>
									</div>
									<div class="item-category category-5">
										<a href="#">
											<img src="img/theme/icon/home-4/icon-5.png" alt="">
											<p>ACCESSORIES</p>
										</a>
									</div>
								</div>
		...
		<section class="so-spotlight3">
			<div class="container">
				<div class="row">
					<div class="col-sm-12">
						<h3 class="modtitle4">New Arrivals</h3>
						<hr>
						<div class="text">
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor</p>
							<p>incididunt ut labore et dolore magna aliqua</p>
						</div>
						<div class=" owl-carousel owl-new-arrivals " data-dots="no" data-nav="yes" data-loop="yes" data-items_xs="1" data-items_sm="3" data-items_md="4" data-margin="30">
							<div class="item-new-arrivals">
								<div class="product-layout">
									<div class="product-item-container">
										<div class="left-block">
											<div class="product-image-container  second_img ">
												<a href="product.html" class="product-img"><img src="img/demo/shop/product/home-3/product-1.jpg" alt=""></a>
												<!--Sale Label-->
								...
								<div class="product-layout">
									<div class="product-item-container">
										<div class="left-block">
											<div class="product-image-container  second_img ">
												<a href="product.html" class="product-img"><img src="img/demo/shop/product/home-3/product-2.jpg" alt=""></a>
												<!--Sale Label-->
												<span class="new">New</span>

												<div class="hover-1">
													<ul>
														<li class="icon-cart"><a class="addToCart btn-button"   data-toggle="tooltip" title="" onclick="cart.add('140');" data-original-title="Add To Cart"><span><i class="fa fa-shopping-cart" aria-hidden="true"></i></span></a></li>
														<li class="icon-heart"><a class="wishlist btn-button"   data-toggle="tooltip" title="" onclick="wishlist.add('140');" data-original-title="Add to Wish List"><i class="fa fa-heart"></i></a></li>
														<li class="icon-exchange"><a class="compare btn-button"   data-toggle="tooltip" title="" onclick="compare.add('140');" data-original-title="Compare this Product"><i class="fa fa-refresh"></i></a></li>
														<li class="icon-search"><a class="quickview iframe-link " data-fancybox-type="iframe" href="quickview.html">  <i class="fa fa-search" aria-hidden="true"></i></a></li>
													</ul>
							...
							<div class="item-new-arrivals">
								<div class="product-layout">
									<div class="product-item-container">
										<div class="left-block">
											<div class="product-image-container  second_img ">
												<a href="product.html" class="product-img"><img src="img/demo/shop/product/home-3/product-3.jpg" alt=""></a>
												<!--Sale Label-->
												<span class="new">New</span>
								...
								<div class="product-layout">
									<div class="product-item-container">
										<div class="left-block">
											<div class="product-image-container  second_img ">
												<a href="product.html" class="product-img"><img src="img/demo/shop/product/home-3/product-4.jpg" alt=""></a>
												<!--Sale Label-->
							...
							<div class="item-new-arrivals">
								<div class="product-layout">
									<div class="product-item-container">
										<div class="left-block">
											<div class="product-image-container  second_img ">
												<a href="product.html" class="product-img"><img src="img/demo/shop/product/home-3/product-5.jpg" alt=""></a>
												<!--Sale Label-->
								...
								<div class="product-layout">
									<div class="product-item-container">
										<div class="left-block">
											<div class="product-image-container  second_img ">
												<a href="product.html" class="product-img"><img src="img/demo/shop/product/home-3/product-6.jpg" alt=""></a>
												<!--Sale Label-->
							...
							<div class="item-new-arrivals">
								<div class="product-layout">
									<div class="product-item-container">
										<div class="left-block">
											<div class="product-image-container  second_img ">
												<a href="product.html" class="product-img"><img src="img/demo/shop/product/home-3/product-7.jpg" alt=""></a>
												<!--Sale Label-->
								...
								<div class="product-layout">
									<div class="product-item-container">
										<div class="left-block">
											<div class="product-image-container  second_img ">
												<a href="product.html" class="product-img"><img src="img/demo/shop/product/home-3/product-8.jpg" alt=""></a>
												<!--Sale Label-->
												<span class="new">New</span>
							...
							<div class="item-new-arrivals">
								<div class="product-layout">
									<div class="product-item-container">
										<div class="left-block">
											<div class="product-image-container  second_img ">
												<a href="product.html" class="product-img"><img src="img/demo/shop/product/home-3/product-9.jpg" alt=""></a>
												<!--Sale Label-->
												<span class="sale">-25%</span>
								...
								<div class="product-layout">
									<div class="product-item-container">
										<div class="left-block">
											<div class="product-image-container  second_img ">
												<a href="product.html" class="product-img"><img src="img/demo/shop/product/home-3/product-10.jpg" alt=""></a>
												<!--Sale Label-->
										...
										<div class="right-block">
											<div class="caption">
												<h4><a href="product.html">Dummy product #10</a></h4>		
												<div class="ratings">
													<div class="rating-box">
														<span class=""><i class="fa fa-star "></i></span>
														<span class=""><i class="fa fa-star "></i></span>
							...
							<div class="item-new-arrivals">
								<div class="product-layout">
									<div class="product-item-container">
										...
										<div class="right-block">
											<div class="caption">
												<h4><a href="product.html">Dummy product #11</a></h4>		
												<div class="ratings">
													<div class="rating-box">
														<span class=""><i class="fa fa-star "></i></span>
														<span class=""><i class="fa fa-star "></i></span>
								...
								<div class="product-layout">
									<div class="product-item-container">
										...
										<div class="right-block">
											<div class="caption">
												<h4><a href="product.html">Dummy product #12</a></h4>		
												<div class="ratings">
													<div class="rating-box">
														<span class=""><i class="fa fa-star "></i></span>
														<span class=""><i class="fa fa-star "></i></span>
		...
		<section class="so-spotlight4 box-full">
			<div class="container-fluid">
				<div class="row">
					<div class="col-sm-12">
						<div class="banners4">
							<div class="banner banner-1">
								<div class="banner-img">
									<img src="img/demo/banner/home-4/banner-1.jpg" alt="">
								</div>
							...
							<div class="banner banner-2">
								<div class="banner-img">
									<img src="img/demo/banner/home-4/banner-2.jpg" alt="">
								</div>
								<div class="banner-info">
									<h3>spring & summer</h3>
									<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
		...
		<section class="so-spotlight5">
			<div class="container">
				<div class="row">
					<div class="col-sm-12">
						<h3 class="modtitle4">Latest Blog</h3>
						<hr>
						<div class="text">
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor</p>
							<p>incididunt ut labore et dolore magna aliqua</p>
						</div>
						<div class=" owl-carousel owl-latest-news " data-dots="yes" data-nav="yes" data-loop="yes" data-items_xs="1" data-items_sm="2" data-items_md="2" data-margin="30">
							<div class="latest-new-items">
								<div class="item-container">
									<div class="top-block">
										
										<div class="item-img">
											<a href="blog-detail.html"><img src="img/demo/blog/home-3/latest-news-1.jpg" alt=""></a>
										</div>
									</div>
									<div class="bottom-block">
										<div class="date-time">
											<p class="day">24</p>
											<p class="mon">December, 2017</p>
										</div>
										<h4><a href="blog-detail.html">Black Friday January 2017</a></h4>
										<p>Lorem ipsum dolor sit amet, consectetur mo adipiscing elit, sed do eiusmod.</p>
										<a href="#" class="view">View More <i class="fa fa-angle-double-right" aria-hidden="true"></i></a>
									</div>
								</div>
							</div>
							...
							<div class="latest-new-items">
								<div class="item-container">
									<div class="top-block">
										...
										<div class="item-img">
											<a href="blog-detail.html"><img src="img/demo/blog/home-3/latest-news-2.jpg" alt=""></a>
										</div>
									</div>
									<div class="bottom-block">
										<div class="date-time">
											<p class="day">19</p>
											<p class="mon">November, 2017</p>
										</div>
										<h4><a href="blog-detail.html">Black Friday January 2017</a></h4>
										<p>Lorem ipsum dolor sit amet, consectetur mo adipiscing elit, sed do eiusmod.</p>
										<a href="#" class="view">View More <i class="fa fa-angle-double-right" aria-hidden="true"></i></a>
							...
							<div class="latest-new-items">
								<div class="item-container">
									<div class="top-block">
										...
										<div class="item-img">
											<a href="blog-detail.html"><img src="img/demo/blog/home-3/latest-news-3.jpg" alt=""></a>
										</div>
									</div>
									<div class="bottom-block">
										<div class="date-time">
						...
						<div class="brand">
							<div class="owl-carousel owl-brand" data-margin="15" data-nav="yes" data-dots="no" data-loop="yes" data-items_xs="2" data-items_sm="4" data-items_md="5">
								<div class="item-brand">
									<a href="#"><img src="img/demo/brands/home-3/brand-1.jpg" alt=""></a>
								</div>
								<div class="item-brand">
									<a href="#"><img src="img/demo/brands/home-3/brand-2.jpg" alt=""></a>
								</div>
								<div class="item-brand">
									<a href="#"><img src="img/demo/brands/home-3/brand-3.jpg" alt=""></a>
								</div>
								<div class="item-brand">
									<a href="#"><img src="img/demo/brands/home-3/brand-4.jpg" alt=""></a>
								</div>
								<div class="item-brand">
									<a href="#"><img src="img/demo/brands/home-3/brand-5.jpg" alt=""></a>
								</div>
								<div class="item-brand">
									<a href="#"><img src="img/demo/brands/home-3/brand-6.jpg" alt=""></a>
								</div>
		...
		<!-- Footer Container -->
		<footer class="footer-container box-full type_footer4">
					...
					<div class=" container">
						<div class=" row">
							<div class=" news-letter">
								<div class="sign-up col-xs-12 col-sm-12 col-md-6">
									<h3 class="modtitle"><span>Sign up for</span> newsletter</h3>	
								</div>
								
								<div class="email col-xs-12 col-sm-12 col-md-6">
			...
			<div class="footer-b">
				...
				<section class="footer-mid">
					<div class="container content">
						<div class="row">
							<div class="share-icon col-sm-12">
								<div class="logo">
									<a href="#"><img src="img/demo/logo/home-4/logo.png" alt=""></a>
								</div>
								<ul>
									...
									<li class="skype"><a href="#"><i class="fa fa-pinterest  " aria-hidden="true"></i></a></li>
								</ul>
							</div>
						</div>
				...
				<section class="footer-bot">
					<div class="container">
						<div class="row">
							<div class="col-sm-5 collapsed-block ">
								<div class="module clearfix">
									<h3 class="modtitle">About Us	</h3>
									<div class="modcontent">
										<ul class="contact-address">
											<li><p><span class="fa fa-home" aria-hidden="true"></span>No 40 Baria Sreet 133/2 NewYork City, NY, United States</p></li>
							...
							<div class="col-sm-2 box-information">
								<div class="module clearfix">
							...
							<div class="col-sm-3 box-account">
								<div class="module clearfix">
			...
			<div class=" container">
				<div class="row">
					<div class="footer-bottom-header">
						<div class="text-footer-bot col-sm-6">
							<p>Copyright © 2017 by <a href="#">OpenCartWorks</a> . All Rights Reserved.</p>
						</div>
			...
			<form action="" method="post" class="myform" >
				...
				<div class="panel-group">
					...
					<div class="group-schemes">
						<input name="cplthemesColors" class="minicolors minicolors-input form-control" type="text" value="#f55" size="7">
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				...
				<div class="modal-body"> 
					<textarea id="getCSSTextarea" class="get-css" readonly=""><?php $fileCssName = !empty($themeCssName) ?  $themeCssName : 'home4.css'; echo '/********************************************
						' ;
