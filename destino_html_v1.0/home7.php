...
<head>
	...
	<link href="css/footer7.css" rel="stylesheet">
	...
	<div id="wrapper" class="wrapper-full banners-effect-8">
		...
		<header id="header" class=" variantleft  type_7">
							...
							<div class="form-group languages-block ">
								<form action="index.html" method="post" enctype="multipart/form-data" id="bt-language">
									...
									<ul class="dropdown-menu" >
										...
										<li> <a href="html_width_RTL/home7.php"> <img class="image_flag" src="img/demo/flags/lb.png" alt="Arabic" title="Arabic"> Arabic </a> </li>
									</ul>
								</form>
							</div>
						</div>
						<div class="header-top-right collapsed-block text-right  col-sm-6 col-xs-6 compact-hidden">
							<div class="tabBlock" id="TabBlock-1">
								<ul class="top-link list-inline">
									<li class="wishlist hidden-xs"><a href="wishlist.html" id="wishlist-total" class="top-link-wishlist" title="Welcome Customer!"><span>Welcome Customer!</span></a></li>
									<li class="login"><a href="login.html" class="top-link-checkout" title="Sign In"><span>Login</span></a></li>
			...
			<div class="header-center left">
				<div class="container">
					<div class="row">
						<div class="search col-lg-3 col-md-3 col-sm-4 ">
							...
							<div class=" visible-xs">
								<div class="btn-search">
									<button class="btn  "   ><i class="fa fa-search search1" aria-hidden="true"></i>
									</button>
								</div>
						...
						<!-- Logo -->
						<div class="navbar-logo col-lg-7 col-md-7  col-sm-5 col-xs-12">
							<a href="index.php"><img src="img/demo/logo/home-7/logo.png" title="Your Store" alt="Your Store"></a>
						</div>
						<!-- //end Logo -->

						
						<div class=" shopping_cart pull-left col-md-2 col-sm-3 col-xs-4">
			...
			<div class="header-bot">
				<div class="container">
					<div class="row">
						<div class="megamenu-hori col-lg-12  col-md-12  col-sm-12 col-xs-6 ">
		...
		<div class="content-main home-7">
			<section class="so-spotlight1 container-fluid">
				<div class="owl-slider">
					<div class="owl-carousel " data-margin="0" data-nav="yes" data-loop="yes" data-items_xs="1" data-items_sm="1" data-items_md="1">
						<div class="slider">
							<a href="#"><img src="img/demo/slider/home-7/slider-1.jpg" alt=""></a>
						</div>
						<div class="slider">
							<a href="#"><img src="img/demo/slider/home-7/slider-2.jpg" alt=""></a>
						</div>
						<div class="slider">
							<a href="#"><img src="img/demo/slider/home-7/slider-3.jpg" alt=""></a>
						</div>
					</div>
				</div>
			</section>
			...
			<section class="so-spotlight3">
				<div class="container">
					<div class="row">
						<div class="col-sm-12">
							<div class="deals-week">
								<h3 class="modtitle7">Deals of the Day</h3>
								<hr>
								<div class="text">
									<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor</p>
									<p>incididunt ut labore et dolore magna aliqua</p>
								</div>
								<div class="owl-carousel owl-dead-week" data-dots="yes" data-nav="no" data-loop="yes" data-items_xs="1" data-items_sm="2" data-items_md="2" data-margin="15" >
									<div class="product-layout">
										<div class="product-item-container">
											<div class="left-block">
												<div class="product-image-container  second_img ">
													<a href="product.html" class="product-img"><img src="img/demo/shop/product/home-7/product-1.jpg" alt=""></a>
													<!--Sale Label-->
									...
									<div class="product-layout">
										<div class="product-item-container">
											<div class="left-block">
												<div class="product-image-container  second_img ">
													<a href="product.html" class="product-img"><img src="img/demo/shop/product/home-7/product-2.jpg" alt=""></a>
													<!--Sale Label-->
													<span class="new">New</span>
									...
									<div class="product-layout">
										<div class="product-item-container">
											<div class="left-block">
												<div class="product-image-container  second_img ">
													<a href="product.html" class="product-img"><img src="img/demo/shop/product/home-7/product-3.jpg" alt=""></a>
													<!--Sale Label-->
													<span class="new">New</span>
			...
			<section class="so-spotlight4">
				<div class="container">
					<div class="row">
						<div class="col-lg-12">
							<h3 class="modtitle7">our Collections</h3>
							<hr>
							<div class="text">
								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor</p>
								<p>incididunt ut labore et dolore magna aliqua</p>
							...
							<div class="collections">
								<div class="row">
									<div class="col-sm-4 col-xs-12 collection">
										<a href="#">
											<div class="img-collection">
												<img src="img/demo/collections/home-7/c1.jpg" alt="">
											</div>
											<h4>Men watches</h4>
										</a>
									</div>
									<div class="col-sm-4 col-xs-12 collection">
										<a href="#">
											<div class="img-collection">
												<img src="img/demo/collections/home-7/c2.jpg" alt="">
											</div>
											<h4>Men watches</h4>
										</a>
									</div>
									<div class="col-sm-4 col-xs-12 collection">
										<a href="#">
											<div class="img-collection">
												<img src="img/demo/collections/home-7/c3.jpg" alt="">
											</div>
											<h4>Men watches</h4>
										</a>
									</div>
			...
			<section class="so-spotlight5">
				<div class="container">
					<div class="row">
						<div class="col-sm-12">
							<h3 class="modtitle7">Bestsellers</h3>
							<hr>
							<div class="text">
								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor</p>
								<p>incididunt ut labore et dolore magna aliqua</p>
							...
							<div class="bestsellers">
								<div class="title-bestsellers">
									<ul class="nav nav-tabs">
										<li class="active"><a data-toggle="tab" href="#product1">Rolex</a></li>
										<li><a data-toggle="tab" href="#product2">Seiko</a></li>
										<li><a data-toggle="tab" href="#product3">Longines</a></li>
										<li><a data-toggle="tab" href="#product4">Orient</a></li>
										<li><a data-toggle="tab" href="#product5">Omega</a></li>
										<li><a data-toggle="tab" href="#product6">Montblanc</a></li>
									</ul>
								</div>
								<div class="product-bestsellers">
									<div class="tab-content">
											...
											<div class="product-tab">
												...
												<div class="product-layout">
													<div class="product-item-container">
														<div class="left-block">
															<div class="product-image-container  second_img ">
																<a href="product.html" class="product-img"><img src="img/demo/shop/product/home-7/product-4.jpg" alt=""></a>
																<!--Sale Label-->
												...
												<div class="product-layout">
													<div class="product-item-container">
														<div class="left-block">
															<div class="product-image-container  second_img ">
																<a href="product.html" class="product-img"><img src="img/demo/shop/product/home-7/product-5.jpg" alt=""></a>
																<!--Sale Label-->
												...
												<div class="product-layout">
													<div class="product-item-container">
														<div class="left-block">
															<div class="product-image-container  second_img ">
																<a href="product.html" class="product-img"><img src="img/demo/shop/product/home-7/product-6.jpg" alt=""></a>
																<!--Sale Label-->
												...
												<div class="product-layout">
													<div class="product-item-container">
														<div class="left-block">
															<div class="product-image-container  second_img ">
																<a href="product.html" class="product-img"><img src="img/demo/shop/product/home-7/product-7.jpg" alt=""></a>
																<!--Sale Label-->
												...
												<div class="product-layout">
													<div class="product-item-container">
														<div class="left-block">
															<div class="product-image-container  second_img ">
																<a href="product.html" class="product-img"><img src="img/demo/shop/product/home-7/product-8.jpg" alt=""></a>
																<!--Sale Label-->
										...
										<div id="product4" class="tab-pane fade">
											<div class="product-tab">
												<div class="product-layout">
													<div class="product-item-container">
														<div class="left-block">
										...
										<div id="product5" class="tab-pane fade">
											<div class="product-tab">
												<div class="product-layout">
													<div class="product-item-container">
														<div class="left-block">
										...
										<div id="product6" class="tab-pane fade">
											<div class="product-tab">
												<div class="product-layout">
													<div class="product-item-container">
														<div class="left-block">
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="laest-post">
								...
								<div class="owl-carousel owl-laest-post" data-margin="30" data-nav="no" data-dots="yes" data-loop="yes" data-items_xs="1" data-items_sm="3" data-items_md="4">
									<div class="item-laest-post">
										<div class="date-post">
											<p><span class="day">24</span> / Decemer</p>
										</div>
										<div class="title-post">
											<a href="blog-detail.html"><h3>Black Friday event December 2016</h3></a>
										</div>
										<div class="content-post">
											Lorem ipsum dolor sit amet, consectetur mo adipiscing elit, sed do eiusmod tempor incidi ut labore et dolore magna aliqua.
										</div>
										<div class="view-more">
									...
									<div class="item-laest-post">
										<div class="date-post">
											<p><span class="day">06</span> / Novermer</p>
										</div>
										<div class="title-post">
											<a href="blog-detail.html"><h3>Black Friday event December 2016</h3></a>
										</div>
									...
									<div class="item-laest-post">
										<div class="date-post">
											<p><span class="day">17</span> / September</p>
										</div>
										<div class="title-post">
											<a href="blog-detail.html"><h3>Black Friday event December 2016</h3></a>
										</div>
									...
									<div class="item-laest-post">
										<div class="date-post">
											<p><span class="day">30</span> / March</p>
										</div>
										<div class="title-post">
											<a href="blog-detail.html"><h3>Black Friday event December 2016</h3></a>
										</div>
		...
		<!-- Footer Container -->
		<footer class="footer-container  type_footer7">
