							...
							<div class="form-group languages-block ">
								<form action="index.html" method="post" enctype="multipart/form-data" id="bt-language">
									...
									<ul class="dropdown-menu" >
										...
										<li> <a href="html_width_RTL/home3.php"> <img class="image_flag" src="img/demo/flags/lb.png" alt="Arabic" title="Arabic"> Arabic </a> </li>
									</ul>
								</form>
							</div>
						</div>
						<div class="header-top-right collapsed-block text-right  col-sm-6 col-xs-6 compact-hidden">
							...
							<div class="tabBlock" id="TabBlock-1">
								<ul class="top-link list-inline">
									<li class="wishlist hidden-xs"><a href="home3.html" id="wishlist-total" class="top-link-wishlist" title="Welcome Customer!"><span>Welcome Customer!</span></a></li>
						...
						<div class="collections">
							...
							<section class="so-spotlight7">
								<div class="container">
									<div class="row">
										<div class="col-sm-12">
											<h3 class="modtitle3">Latest New</h3>
											<hr>
											<div class="text">
												<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor</p>
												<p>incididunt ut labore et dolore magna aliqua</p>
											</div>
											<div class=" owl-carousel owl-latest-news " data-dots="no" data-nav="yes" data-loop="yes" data-items_xs="1" data-items_sm="3" data-items_md="3" data-margin="30">
	...
	<section class="footer-top">
						...
						<div class="module clearfix">
							...
							<div class="modcontent">
								<ul class="contact-address">
									...
									<li><span class="fa fa-envelope-o"></span>Hiesign@Magentech.com</li>
		...
		<div class="footer-mid">
			<div class=" newsletter">
				<div class=" container">
					<div class=" row">
						<div class="col-xs-12 col-sm-12 col-md-9 news-letter">
							<h3 class="modtitle3"><span>Sign up for</span><br> newsletter</h3>	
							<div class="email">
						...
						<div class="share-icon col-xs-12 col-sm-12 col-md-3 ">
							<ul>
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				...
				<div class="modal-body"> 
					<textarea id="getCSSTextarea" class="get-css" readonly=""><?php $fileCssName = !empty($themeCssName) ?  $themeCssName : 'home3.css'; echo '/********************************************
						' ;
