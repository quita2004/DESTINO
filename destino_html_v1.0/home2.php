								...
								<div class="form-group languages-block ">
									<form action="index.html" method="post" enctype="multipart/form-data" id="bt-language">
										...
										<ul class="dropdown-menu" >
											...
											<li> <a href="html_width_RTL/home2.php"> <img class="image_flag" src="img/demo/flags/lb.png" alt="Arabic" title="Arabic"> Arabic </a> </li>
										</ul>
									</form>
								</div>
							</div>
								...
								<div id="cart" class=" btn-group btn-shopping-cart">
									<a data-loading-text="Loading..." class="top_cart dropdown-toggle" data-toggle="dropdown">
										<div class="shopcart">
											...
											<p class="text-shopping-cart cart-total-full hidden-xs"> $0.00 </p>
										</div>
									</a>
												...
												<div class="megamenu-pattern">
													<div class="container">
														<ul class="megamenu " data-transition="slide" data-animationtime="250">
															...
															<li class="with-sub-menu hover sub-menu-page">
																<p class="close-menu"></p>
																<a href="#" class="clearfix menu1">
																	<strong>Pages</strong>
			...
			<section class="so-spotlight1">
				<div id="so-slideshow" >
					<div class="owl-carousel" data-loop="yes" data-margin="0" data-nav="yes" data-dots="yes" data-items_xs="1" data-items_sm="1" data-items_md="1">
						<div><a href="#"><img src="img/demo/slider/home-2/slider-1.jpg" alt=""></a></div>
						<div><a href="#"><img src="img/demo/slider/home-2/slider-2.jpg" alt=""></a></div>
						<div><a href="#"><img src="img/demo/slider/home-2/slider-3.jpg" alt=""></a></div>
					</div>
				...
				<div class="main-container container">
					...
					<div class="row">
						<aside class="col-md-3 col-sm-4 col-xs-12  content-aside left_column">
							<div class="special">
								<h3 class="modtitle">Special Offers</h3>
								<hr><hr><hr>
									...
									<div class="product-layout">
										<div class="product-item-container">
											<div class="left-block">
												...
												<div class="hover">
													<ul>
														<li class="icon-heart"><a class="wishlist"   data-toggle="tooltip" title="" onclick="wishlist.add('42');" data-original-title="Add to Wish List"><i class="fa fa-heart"></i></a><div class="tooltip fade top" role="tooltip" id="tooltip81616" style="top: -79px; left: 0px; display: block;"><div class="tooltip-arrow"></div><div class="tooltip-inner">Add to Wish List</div></div></li>
														<li class="icon-exchange"><a class="compare"   data-toggle="tooltip" title="" onclick="compare.add('42');" data-original-title="Compare this Product"><i class="fa fa-exchange"></i></a></li>
														<li class="icon-search"><a class="quickview iframe-link " data-fancybox-type="iframe" href="quickview.html">  <i class="fa fa-search" aria-hidden="true"></i></a></li>
													</ul>
												</div>
							...
							<div class="testimonials">
								...
								<hr><hr><hr>
								<div class="owl-carousel" data-margin="0" data-nav="no" data-loop="yes" data-dots="yes" data-items_xs="1" data-items_sm="1" data-items_md="1">
									<div class="owl-testimonials">
										<div class="content">
											<p>Lorem ipsum dolor sit amet, conmetur asdipiscing elit,sed doeius tempo lorem ipsum raLorem ipsum dolor sit amet, consec tetur adipiscing elit, sed do eiusmod.</p>
										</div>
										<div class="avata"><img src="img/theme/home-2/avata.jpg" alt=""></div>
										<div class="name"><p>Johny Walker</p></div>
										<div class="job"><p>CEO Envato - Themeforest</p></div>
									</div>
							...
							<div class="latest-blog">
								...
								<hr><hr><hr>
								<div class="owl-carousel owl-blog" data-margin="0" data-nav="yes" data-loop="yes" data-items_xs="1" data-items_sm="1" data-items_md="1">
									<div class="owl-latest-blog">
											...
											<div class="itemBlogImg">
												<div class="article-image ">
													<div>
														...
														<a class="popup-gallery" href="blog-detail.html"><img src="img/demo/blog/blog-1.jpg" alt="Kire tuma demonstraverunt lector"></a>
													</div>
												</div>
											</div>
											<div class="itemBlogContent1">
												<div class="article-title1">
													<h4>
														<a href="blog-detail.html">Kire Tuma Demonstrav</a>
													</h4>
												</div>
												<div class="article-description1">
													Lorem ipsum dolor sit amet, consectetur mo adipiscing elit, sed do eiusmod tempor incidi ut labore et dolore magna aliqua... </div>
													<div class="blog-meta1">
														<span class="comment_count1">
										...
										<div class="module banner-left hidden-xs">
											<div class="modcontent clearfix">
												<div class="banners">
													<div>
														<a href="#"><img src="img/demo/banner/home-2/banner-3.jpg" alt="left-image"></a>
													</div>
												</div>
									...
									<div id="content" class="col-md-9 col-sm-8  col-xs-12">
										<div class="digital">
											<div class="row">
												<div class=" col-sm-12">
													<h3 class="modtitle">Digital & Electronics</h3>
													<hr>
													<hr>
													<hr>
										...
										<div class=" fashion-jewerly">
											<div class="row">
												<div class=" col-sm-12">
													<h3 class="modtitle">Fashion & Jewelry</h3>
													<hr>
													<hr>
													<hr>
													<div class="fashion-jewerly-owl">
														<div class=" owl-carousel fashion-jewerly-owl " data-dots="no" data-nav="yes" data-loop="yes" data-items_xs="1" data-items_sm="2" data-items_md="4" data-margin="10">
															<div class="product-layout">
																<div class="product-item-container">
																	<div class="left-block">
																		<div class="product-image-container  second_img ">
																			<a href="product.html" class="product-img"><img src="img/demo/shop/product/product-8.jpg" alt=""></a>
																			<!--Sale Label-->
																			<span class="new">New</span>
										...
										<div class="banner hidden-xs">
											<div class="row">
												<div class="banners">
													<div class="banner-1 col-sm-6 col-xs-12">
														<a href="#"><img src="img/demo/banner/home-2/banner-1.jpg" alt=""></a>
													</div>
													<div class="banner-2 col-sm-6 col-xs-12">
														<a href="#"><img src="img/demo/banner/home-2/banner-2.jpg" alt=""></a>
													</div>
												</div>
											</div>
										</div>
						...
						<div class="module clearfix">
							...
							<div class="modcontent">
								<ul class="contact-address">
									<li><p><span class="fa fa-home"></span><span>Address : </span> My Company, 42 avenue des Champs Elysées</p></li>
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				...
				<div class="modal-body"> 
					<textarea id="getCSSTextarea" class="get-css" readonly=""><?php $fileCssName = !empty($themeCssName) ?  $themeCssName : 'home2.css'; echo '/********************************************
						' ;
